...
<jsp:include page="../main/header.jsp" />
				            ...
				            <div class="col-md-14">
				               ...
				               <div class="portlet box blue-steel">
				                  <div class="portlet-title">
				                     <div class="caption"><span style="font-weight: bold; "><i class="icon-globe"></i>Item List</span></div>
				                      <div class="actions">
				                        <div class="btn-group">
				                           <div class="caption"><a href="../../view/item/ItemViewAction.do" class="btn yellow" title="Create New Item"><span style="font-weight: bold; color: black;"><i class="fa fa-plus"></i> Create Item</span></a></div>
				                        </div>
				                     </div>
				                     <!-- <div class="tools">
				                  ...
				                  <div class="portlet-body">
				                     <table class="table table-striped table-bordered table-hover table-full-width" id=example>
				                        <thead>
				                             <tr>
				                                <th id="th1" style="width:5%;">Item Id</th>
				                                <th>Item Name</th>                               
				                                <th>Price</th>
   ...
   <jsp:include page="../main/footer.jsp" />
    <jsp:include page="../master/itemListJS.jsp"/>
