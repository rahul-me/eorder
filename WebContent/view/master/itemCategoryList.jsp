...
<jsp:include page="../main/header.jsp" />
					            ...
					            <div class="col-md-14">
					               ...
					               <div class="portlet box blue-steel">
					                  <div class="portlet-title">
					                     <div class="caption"><span style="font-weight: bold;"><i class="icon-globe"></i>Item Category List</span></div>
					                     <div class="actions">
				                            <div class="btn-group">
				                              <div class="caption"><a href="../../view/itemcategories/ItemCategoryViewAction.do" title="Create New Item Category" class="btn yellow"><span style="font-weight: bold; color: black;"><i class="fa fa-plus"></i> Create Item Category</span></a></div>
				                            </div>
				                         </div>
					                  </div>
   ...
   <jsp:include page="../master/itemCategoryListJS.jsp" />
