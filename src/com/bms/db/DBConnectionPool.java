...
public class DBConnectionPool implements Runnable {
	...
	private static final  String TAG = "com.java.restoserver.db.DBConnectionPool" ;
	private static final Logger logger = Logger.getLogger(TAG);

	private static DBConnectionPool dbConnectionPool;
	
	private String driver = "com.mysql.jdbc.Driver";
	private String url = "jdbc:mysql://localhost:3306/orderingdb";
	private String username = "root";
	private String password = "ric#101991";
	...
	private String dbPortNumber = null;
	...
	private DBConnectionPool() {
		 ...
		 dbHostName=messages.getString("SMARTORDER.LOCAL.DB.HOSTNAME");
		 dbPortNumber=messages.getString("SMARTORDER.LOCAL.DB.PORT");
         dbName=messages.getString("SMARTORDER.LOCAL.DB.DBNAME");
		 //init the url with the parameters
		 url = "jdbc:mysql://"+dbHostName+":"+dbPortNumber+"/"+dbName+"";
...
//			logger.error("adding new connection no " + i);
	...
	public synchronized Connection getConnection()throws SQLException {
		if (!availableConnections.isEmpty()) {
			...
			System.out.println("Available Connection is -"+availableConnections.size());
...
//			logger.error("in getConnection giving connections no " + lastIndex);
			...
			if (!existingConnection.isValid(5)) {   //wait for 5 sec max to complete the connection
