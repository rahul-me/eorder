...
<jsp:include page="../main/header.jsp" />
				...
				<!-- BEGIN CONTENT -->
   				<div class="page-content-wrapper">
					...
					<div class="page-content">
				         ...
				         <html:form styleId="companyForm" action="/view/company/CompanyMasterAction">
				         <!-- BEGIN PAGE CONTENT-->
				         <div class="row">
				            <div class="col-md-14">
				               ...
				               <div class="portlet box blue-steel">
				                  <div class="portlet-title">
				                     <div class="caption"><span style="font-weight: bold;"><i class="icon-globe"></i>Company List</span></div>
				                      <div class="actions">
				                        <div class="btn-group">
				                           <div class="caption"><a href="../../view/master/companyEntry.jsp" class="btn yellow" title="Create New Company"><span style="font-weight: bold; color: black;"><i class="fa fa-plus"></i> Create Company</span></a></div>
				                        </div>
				                     </div>
				                  ...
				                  <div class="portlet-body">
				                     <table class="table table-striped table-bordered table-hover table-full-width" id=example>
				                        <thead>
				                             <tr>
				                                <th id="th1" style="width:5%;">Company Id</th>
				                                <th>Company Name</th>
   ...
   <jsp:include page="../main/js_listPage.jsp"/>
    <jsp:include page="../master/companyListJS.jsp"/>
