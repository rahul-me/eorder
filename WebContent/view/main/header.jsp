...
<%@page import="com.bms.constants.Constants"%>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<%=session.getAttribute(Constants.SESSION_INFO_USERNAME) +"      "+session.getAttribute(Constants.SESSION_INFO_USERLASTNAME)%></span>
					<i class="fa fa-angle-down"></i>
					</a>
					<ul class="dropdown-menu dropdown-menu-default">
						<%-- <li>
							<a href="../users/UsersViewAction.do?userId=<%=session.getAttribute("userId")%>">
							<i class="icon-calendar"></i> My Profile </a>
						</li>
						<li>
