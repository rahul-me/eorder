...
<jsp:include page="../main/header.jsp" />
					            ...
					            <div class="col-md-14">
					               ...
					               <div class="portlet box blue-steel">
					                  <div class="portlet-title">
					                     <div class="caption"><span style="font-weight: bold;"><i class="icon-globe"></i>Measurement List</span></div>
					                     <div class="actions">
					                        <div class="btn-group">
					                           <div class="caption"><a href="../../view/master/measurement.jsp" class="btn yellow" title="Create New Measurement"><span style="font-weight: bold; color: black;"><i class="fa fa-plus"></i> Create Measurement</span></a></div>
					                        </div>
					                     </div>
   ...
   <jsp:include page="../main/js_listPage.jsp"/>
    <jsp:include page="../master/measurementListJS.jsp" />
