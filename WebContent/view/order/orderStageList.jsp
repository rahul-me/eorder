...
<jsp:include page="../main/header.jsp" />
   				...
   				<div class="page-content-wrapper">
					...
					<div class="page-content">
					  ...
					  <!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->               
				         ...
				         <html:form styleId="OrderStageForm" action="/view/orderstage/OrderStageMasterAction">
				         <!-- BEGIN PAGE CONTENT-->
				         <div class="row">
				            <div class="col-md-14">
				               ...
				               <div class="portlet box blue-steel">
				                  <div class="portlet-title">
				                     <div class="caption"><span style="font-weight: bold;"><i class="icon-globe"></i>OrderStage List</span></div>
				                      <div class="actions">
				                        <div class="btn-group">
				                           <div class="caption"><a href="../../view/order/orderStage.jsp" class="btn yellow"><span style="font-weight: bold; color: black;"><i class="fa fa-plus"></i> Create OrderStage</span></a></div>
				                        </div>
				                     </div>
				                  ...
				                  <div class="portlet-body">
				                     <table class="table table-striped table-bordered table-hover table-full-width" id=example>
				                        <thead>
				                             <tr>
				                                <th id="th1" style="width:5%;">OrderStage Id</th>
				                                <th>OrderStage Name</th>                                
				                                <th>Created BY</th>
				                                <th>Created On</th>
				                                <th>Status</th>
				                                <th>Edit</th>
   ...
   <jsp:include page="../main/js_listPage.jsp"/>
    <jsp:include page="../order/orderStageListJS.jsp"/>
