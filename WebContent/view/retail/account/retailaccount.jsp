				    	...
				    	<div class="col-md-12">
				         	<div class="portlet box blue-steel">
				                ...
				                <div class="portlet-body form">
				                	<html:form styleClass="form-horizontal seperator" action="/view/retail/account/accountAction" styleId="AccountDetailForm">				                    	    	
							        	<div class="form-body">							                        
							                ...
							                <div class="form-group">
							                	<label class="col-md-4 control-label">Supplier Reference Number</label>
							                    <div class="col-md-3">
				                                	<html:text styleClass="form-control" styleId="suppref"  property="suppref"/>
							                    </div>
							                </div>
							            </div>							                        
